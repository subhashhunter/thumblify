        ...
        <div className={`relative overflow-hidden ${aspectClasses[aspectRatio]}`}>
            {isloading && (
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 bg-black/25">
                    ...
                    <div className="text-center">
                        <p className="text-sm font-medium text-zinc-400">AI is creating your thumbnail</p>
            ...
            {!isloading && thumbnail?.image_url && (
                <div className="group relative h-full w-full">
                    ...
                    <div className="absolute inset-0 flex items-end justify-center bg-black/10 opacity-0
                    transition-opacity group-hover:opacity-100">
                        <button onClick={onDownload} type="button" className="mb-6 flex items-center
                        gap-2 rounded-md px-5 py-2.5 text-xs font-medium
                        transition bg-white/30 ring-2 ring-white/40
            ...
            {!isloading && !thumbnail?.image_url && (
                <div className="absolute inset-0 m-2 flex flex-col
